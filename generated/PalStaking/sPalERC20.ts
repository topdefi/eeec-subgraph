...
export class sPalERC20__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class sPalERC20 extends ethereum.SmartContract {
  static bind(address: Address): sPalERC20 {
    return new sPalERC20("sPalERC20", address);
  }
  ...
  rebases(param0: BigInt): sPalERC20__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new sPalERC20__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(param0: BigInt): ethereum.CallResult<sPalERC20__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
